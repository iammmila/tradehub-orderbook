package com.ab.tradeservice.bdd.testrunner;
...
@CucumberOptions(
        ...
        */
        features = {"src/test/java/com/ab/tradeservice/bdd/features"},
        /**
        ...
        */
        glue = {
                "com.ab.tradeservice.bdd",        // to pick up CucumberSpringConfig
                "com.ab.tradeservice.bdd.steps"   // to pick up step defs
        },
        /**
         * Output formatting.
...
public class TradeServiceBDDTest {
}
